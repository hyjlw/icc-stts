package org.icc.broadcast.generator;
...
public class Generator {
    ...
    public static void main(String[] args) {
        ...
        //手动配置数据源
        String url = "jdbc:mysql://localhost:3306/openim_enterprise?serverTimezone=UTC&useUnicode=true&characterEncoding=utf-8";   //注意修改数据库名
        String name = "root";
        String password = "admin.123";

        //数据库表的设置
        List<String> listTable = Arrays.asList("tip_message");  //设置需要自动代码生成的表名
        List<String> listTableSuffix = Arrays.asList("_b");    //设置 过滤 表的后缀
        List<String> listTablePrefix = Arrays.asList("t_", "c_"); //设置 过滤 表的后缀

        //基本信息
        String author = "Wei Lin";    //作者
        String parent = "com.ai1268";   //父包名
        String module = "chat";   //模块包名
